...
const ov=html.match(/office\.js\?v=(\d+)/); assert(ov && Number(ov[1])>=74,'Office يحمل office.js v74+');
assert(/echarpe-office-v(6[5-9]|[7-9]\d|\d{3,})/.test(sw),'Office cache مرفوع v65+');
