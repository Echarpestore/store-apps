...
assert(/cctv\.js\?v=42[1-9]/.test(html),'CCTV script missing');
assert(office.includes("page === 'cctv'"),'CCTV lifecycle hook missing');
assert(office.includes('ofCctvStop'),'CCTV stop hook missing');
assert(cctv.includes('https://cctv-madinaty.echarpe.store'),'remote gateway missing');
...
assert(/echarpe-office-v(6[8-9]|[7-9][0-9])/.test(sw),'Office SW cache not bumped');
