...
assert(assetAtLeast(pi, 'pos-live.js', 411) && /(?:store-apps|pos|loyalty)-shell-v(?:41[1-9]|4[2-9]\d|[5-9]\d{2,})/.test(psw), 'POS keeps v411 live module under a v411+ application cache');
