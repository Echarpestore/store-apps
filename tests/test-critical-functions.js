...
const MUST = [
  ...
  ['pos-sale.js', 'reconcilePendingPayLines',       'v728 زرار الرصيد/النقط بيرجع بعد مسح السطر'],
  ['stock-move.js', 'stockApply',                   'v731 الطبقة الوحيدة اللي بتحرّك المخزون'],
  ['warehouse.js', 'whResolveDiff',                 'v733 حسم الفروق (القرار بيتثبّت قبل الحركة)'],
  ['warehouse.js', 'trOpenByCode',                  'v733 فتح الشحنة بباركود الإذن'],
  ['warehouse.js', 'isWarehouseDevice',             'v733 جهاز المخزن مبيبعش'],
  ...
  ['credit-ui.js', 'creditRecoverMissing',          'v726 استرجاع خصومات الرصيد اللي ضاعت'],
