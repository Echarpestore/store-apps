...
ok(/(?:store-apps|pos|loyalty)-shell-v(36[7-9]|3[7-9]\d|[4-9]\d{2,})/.test(salesSw), 'Sales SW is v367 or newer');
ok(/(?:store-apps|pos|loyalty)-shell-v(36[7-9]|3[7-9]\d|[4-9]\d{2,})/.test(posSw), 'POS SW is v367 or newer');
