const CACHE_NAME = 'echarpe-tryon-v41';
...
const SHELL = ['./', './index.html', './tryon-core.js', './tryon-app.js', './photo.html', './photo-core.js',
               './assets/catalog.js', './recolor.html', './recolor-core.js', './prep.html', './prep-core.js', './assets/template-01-head.png', './assets/bandana-breathe-head.png', './tryon-3d-core.js', './tryon-3d.js', './tryon-mesh-core.js', './tryon-mesh.js'];
