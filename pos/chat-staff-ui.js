...
(function(){
  ...
  function inject(){
    ...
    css.textContent =
      ...
      + '/* 📷 v675: المعاينة كانت 54px — شريط صغير جدًا، الموظفة بتصوّر المنتج ومبتشوفش اللي اتصوّر قبل ما تبعته. دلوقتي الصورة على سطر لوحدها. */ #ccImgPrev img{flex:1 1 100%; width:100%; height:auto; max-height:34vh; object-fit:contain; border-radius:10px; background:#0f1117; display:block;}'
      + '#ccImgPrev label{font-size:12px; color:#9aa1af; display:flex; gap:5px; align-items:center;}'
      + '.ccProductHead{display:flex;align-items:center;gap:8px;flex:1 1 100%;min-width:0;flex-wrap:wrap;}'
      ...
      + '@media (max-width:760px){#ccCompose{max-height:60dvh;}#ccImgPrev{align-items:stretch;}'
