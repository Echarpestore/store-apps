...
async function confirmPayment(){
  ...
  try{
    ...
    // 2) خصم من المخزون التجريبي + تسجيل الحركة في سجل المخزون
    const batch = db.batch();
    cart.forEach(c=>{
